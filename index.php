...
<body>
    <section id="banner">
        <div class="container mb-5 ajuste">
            <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img class="d-block w-100" src="imagens/images.jpg" alt="Primeiro Slide">
                    </div>
                    <div class="carousel-item">
                        <img class="d-block w-100" src="imagens/imagem2.jpg" alt="Segundo Slide">
                    </div>
                    <div class="carousel-item">
                        <img class="d-block w-100" src="imagens/download.jpg" alt="Terceiro Slide">
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 p-5">
                    <img src="imagens/sobre-01.jpg" class="img-fluid" alt="">
                </div>
                <div class="col-md-6 p-5">
